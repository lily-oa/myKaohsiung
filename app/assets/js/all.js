...
//-----------------------------------------------------------------暫時新學習需用到的語法再寫專案
// forEach 用真正的資料練習
let myData = [{"Kind":"公共充電站","Charge":"免費","Location":"新興區公所 ","Address":" 高雄市新興區中正三路34號1樓(室內停車場)"},
...
console.log(`免費的充電站有${total.free.length}處`);
console.log(`投幣式的充電站有${total.paid.length}處`);